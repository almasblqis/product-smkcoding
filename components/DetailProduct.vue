...
<section class="py-10">
<div class="container">
<NuxtLink to="/products" class="bg-white border border-slate-200 w-max flex items-center gap-1 py-2 px-5 rounded-full mb-7 cursor-pointer">
...
<div class="w-full flex items-center gap-2 bg-[#483D8B] text-white py-3 justify-center rounded-lg cursor-pointer hover:bg-blue-600/80 transition duration-300 relative">
